...
class Manager_DimViewColor(Ui_DialogViewerDimElements):
    ...
    def setupUi(self, DialogStartAppDbChange):
        ...
        self.gui_manager.form_dim_color.accepted.connect(self.fill_table)
    ...
    def create_new_row(self):
        self.gui_manager.ui_form_dim_color.show_window(self.gui_manager.view_dim_color)

    def edit_row(self, item):
        color_id = self.gui_manager.list_manager.get_item_code(item.text())
        color = self.gui_manager.db_manager.get_color_by_code(color_id)
        self.gui_manager.ui_form_dim_color.show_window(self.gui_manager.view_dim_color, color)